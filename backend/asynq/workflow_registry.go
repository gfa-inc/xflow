...
func newWorkflowRegistry(rdb *redis.Client) *workflowRegistry {
	return &workflowRegistry{rdb: rdb}
}
...
func (r *workflowRegistry) GetWorkflow(ctx context.Context, id types.WorkflowID) (backend.WorkflowRecord, error) {
