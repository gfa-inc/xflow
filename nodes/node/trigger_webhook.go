...
func (n *WebhookTriggerNode) Descriptor() Descriptor {
	return Descriptor{
		Type:        "xflow.trigger.webhook",
		Kind:        types.NodeKindTrigger,
		DisplayName: "Webhook Trigger",
		Params: []ParamSpec{
			{Name: "method", DisplayName: "Method", Type: ParamString, Required: true},
			{Name: "path", DisplayName: "Path", Type: ParamString, Required: true},
			{Name: "event_id_header", DisplayName: "Event ID Header", Type: ParamString},
			{Name: "max_body_bytes", DisplayName: "Max Body Bytes", Type: ParamNumber, Default: float64(defaultWebhookMaxBodyBytes)},
		},
...
func (n *WebhookTriggerNode) OnError(s OnError) Builder {
	n.onError = s
	return n
}
